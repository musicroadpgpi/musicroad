package com.nullpoint.musicroad.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.nullpoint.musicroad.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.nullpoint.musicroad.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
